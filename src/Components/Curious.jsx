...
export default function Curious() {
  ...
  <img className={`${styles.image} ${styles.image2}`} src="https://i.imgur.com/WheG8UG.png" />
  <div style={{ color: '#FEC89A'}} className={`${styles.text} ${styles.text2}`}>Exploring Global Treasures</div>
  <div style={{width: 289, height: 42, left: 345, top: 587, position: 'absolute', textAlign: 'center', color: '#B2FF9E', fontSize: 32, fontFamily: 'Fredoka One', fontWeight: '400', wordWrap: 'break-word'}}>Curious Corner</div>
  <img style={{width: 470, height: 280, left: 265, top: 650, position: 'absolute'}} src="https://i.imgur.com/85h4waG.png" />
</div>
    </div>
  )
}
